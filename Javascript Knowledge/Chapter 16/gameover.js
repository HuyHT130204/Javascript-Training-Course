// Vector class for position and movement calculations
class Vec {
    constructor(x, y) {
    this.x = x; this.y = y;
    }
...
// Lava actor class for all hazards
class Lava {
...
// Coin actor class for collectibles
class Coin {
...
// Level class to parse and manage level data
class Level {
    constructor(plan) {
...
// Character mapping for level parsing
const levelChars = {
    ".": "empty",
    "#": "wall",
    "+": "lava",
...
// DOM display class for rendering
class DOMDisplay {
...
// Modified runGame function with lives system
